...
(() => {
  ...
  const config = {"motif":"castNote","trail":"diamondDust","burst":"softDiamondGlow","motion":"still","accent":"#2a7aaa","size":56,"follow":0.52,"emitDistance":18,"clickOn":"down","burstParticles":3,"hotspot":[0.5,0.5],"primary":"#2676a8","secondary":"#edf5f7"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
